...
## Состав решения
mcu_modules - ПО, запускаемое на аппаратном обеспечении на микроконтролерах ATmega328P
operator_modules - ПО, запускаемое на стороне оператора
robot_modules - ПО, запускаемое на стороне робота
data_formats - форматы даных для обмена информацией
